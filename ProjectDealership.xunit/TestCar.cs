...
namespace ProjectDealership.xunit
{
    public class TestCar
    {
        ...
        public void TestFuelInTheCarClass()
        {
            ...
            var car = new Car(true, expectedFuel, "Ferrari", "RT8000", System.DateTime.Now.AddDays(-2), 0, "Red", 1000000);
        ...
        public void TestPriceCalculateMethodInTheCarClass()
        {
            ...
            var car = new Car(true, "Full", "Bugatti", "La Voiture Noire", System.DateTime.Now.AddDays(-2), 0, "Black", expectedPriceCalculate);
