...
namespace ProjectDeleaship.Lib.Models
{
    ...
    public class Car : Vehicle
    {
        ...
        public Car(bool automaticTransmission, string fuel, string brand, string model, string year, int mileage, string color, double price) : base(brand, model, year, mileage, color, price)
        {
